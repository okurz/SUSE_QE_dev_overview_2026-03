...
* Automatic openQA test failure analysis using LLMs: https://openqa.opensuse.org/tests?comment=LLM
...
* Improve text-mode tests view and command output [poo#178885](https://progress.opensuse.org/issues/178885)
